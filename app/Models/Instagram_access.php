...
define('INSTAGRAM_APP_ID', '918045899550871');
define('INSTAGRAM_APP_SECRET', '●●●●●●●●');
define('INSTAGRAM_APP_REDIRECT_URI', 'https://akarjayapackaging.com/');
class Instagram_access extends Model
{
    ...
    private $_userAccessToken = 'IGQVJXOHppcDBjT2xFZAnhZAVlRSTTRWTVJrZAHJXWUhtZAjUxajVBNTNjZAFRWTXYzbUdSZAWdtZAHN5VFRxbjlsSFZAoVS1CeVlaenhpZA1lJNjlHMnFwQlRFODZAuNkt2clp2UkplY212RVhsdzNfUXR6dE4wUgZDZD';
    private $_userAccessTokenExpires = '';

    public $authorizationUrl = '';
    public $hasUserAccessToken = false;
    public $userId = '17841444809124782';
